  ...
  return (
    <>
      ...
      <div className="space-y-6">
        ...
        <div className="no-print bg-white border border-borderEco p-6 rounded-3xl flex flex-col sm:flex-row justify-between items-center gap-4 transition-colors duration-200 shadow-sm">
          <div>
            <h1 className="text-2xl font-extrabold flex items-center space-x-2 text-slate-800 uppercase">
          ...
          <div className="flex space-x-3 w-full sm:w-auto">
            <button
              onClick={loadData}
              disabled={loading}
              className="flex-1 sm:flex-initial border border-slate-200 hover:bg-slate-50 p-3 rounded-xl transition flex items-center justify-center space-x-2 text-sm font-bold text-slate-700"
            >
            ...
            <button
              onClick={handlePrint}
              disabled={loading}
              className="flex-1 sm:flex-initial bg-gradient-to-r from-primary-600 to-secondary-500 text-white font-bold px-6 py-3 rounded-xl shadow-md hover:scale-[1.02] transition flex items-center justify-center space-x-2 text-sm"
            >
              <Printer size={16} />
        ...
        {loading ? (
          ...
          <div className="flex justify-center p-2 sm:p-4 overflow-x-auto">
            <style dangerouslySetInnerHTML={{__html: `
              @media print {
                ...
                .print-certificate-container {
                  ...
                  margin: 0;
                  padding: 30px;
                  border: 15px double #2E7D32 !important;
            ...
            <div className="print-certificate-container w-full max-w-[850px] aspect-[1.414/1] bg-white border-[12px] border-double border-emerald-700/60 p-8 sm:p-12 flex flex-col justify-between relative shadow-xl transition-colors duration-200">
              {/* Watermark shape */}
              ...
              <div className="absolute top-2 left-2 border-t-2 border-l-2 border-emerald-700/40 w-8 h-8"></div>
              <div className="absolute top-2 right-2 border-t-2 border-r-2 border-emerald-700/40 w-8 h-8"></div>
              <div className="absolute bottom-2 left-2 border-b-2 border-l-2 border-emerald-700/40 w-8 h-8"></div>
              <div className="absolute bottom-2 right-2 border-b-2 border-r-2 border-emerald-700/40 w-8 h-8"></div>

              {/* Top Branding Section */}
              <div className="text-center space-y-1">
                <div className="flex justify-center items-center space-x-1.5 text-emerald-600">
                  <img 
                ...
                <h2 className="text-2xl sm:text-3xl font-serif font-extrabold text-slate-800 tracking-tight">
              ...
              <div className="text-center space-y-4 my-6">
                ...
                <div>
                  <h3 className="text-3xl sm:text-4xl font-extrabold text-emerald-650 font-serif tracking-wide underline decoration-dotted decoration-emerald-500/40 decoration-2 underline-offset-8">
                    {user?.username}
                  </h3>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4 border-y border-slate-100 py-4 text-center">
                <div>
                  ...
                  <p className="text-lg sm:text-xl font-extrabold text-slate-800 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base font-extrabold text-primary-600 mt-1 flex items-center justify-center font-serif">
              ...
              <div className="flex justify-between items-end mt-4">
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] font-mono text-slate-600 bg-slate-50 border border-slate-100 px-2 py-0.5 rounded-lg select-all">
                    {verificationHash}
                  </p>
                </div>

                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-4 border-emerald-600/30 flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-emerald-50 to-teal-100">
                  <div className="text-center flex flex-col items-center">
                    <span className="text-lg sm:text-xl">🌿</span>
                    <span className="text-[7px] font-black uppercase text-emerald-700 tracking-tighter">Carbon Seal</span>
                  </div>
                  <div className="absolute inset-0 border border-emerald-500/10 rounded-full animate-pulse"></div>
                </div>

                <div className="text-center w-36">
                  <div className="font-serif italic text-emerald-600 text-sm select-none">
                    Committee Board
                  </div>
